...
Source0  : https://cran.r-project.org/src/contrib/shiny_1.7.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658245052
...
/usr/lib64/R/library/shiny/tests/testthat/_snaps/test-shinyAppTemplate.md
/usr/lib64/R/library/shiny/tests/testthat/_snaps/test-shinyAppTemplate.new.md
